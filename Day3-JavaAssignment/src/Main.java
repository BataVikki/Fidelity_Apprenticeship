...
class PermanentEmployee extends Employee {
    ...
    class TemporaryEmployee extends Employee {
        ...
        public TemporaryEmployee(int id, String Name,int BasicSalary, int DailyWage, int NoOfDays) {
            super(id,Name,BasicSalary);
    ...
    public class Main {
        public static void main(String[] args) {
            ...
            TemporaryEmployee TE = new TemporaryEmployee(345, "varun", 1500,1500, 20);
